<template>
    <div class="home-layout bg-slate-50 min-h-screen flex flex-col">
...
import { Difficulty, myRecords, Record } from "../../utils/record";
...
.home-header { border-bottom: 1px solid var(--p-surface-200, #e2e8f0); }
